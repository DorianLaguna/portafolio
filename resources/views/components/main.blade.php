                    ...
                    <div class="flex flex-col sm:flex-row mt-10">
                        <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                            ...
                            <div class="flex flex-col items-center text-center justify-center">
                                ...
                                <p class="text-base dark:text-gray-400">Raclette knausgaard hella meggs normcore williamsburg enamel pin sartorial venmo tbh hot chicken gentrify portland.</p>
                            </div>
        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-11 mx-auto">
                ...
                <div class="flex justify-center -m-4 text-center">
                    ...
                    <div class="p-4 border-2 border-gray-200 md:w-1/4 sm:w-1/2 w-full">
        ...
        <section class="text-gray-400 bg-gray-100 dark:bg-gray-900 mt-11 body-font">
            ...
            <div class="container mx-auto flex px-5 pb-11 md:flex-row flex-col items-center">
              <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                <h1 class=" sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900 dark:text-white">Before they sold out
                  <br class="hidden lg:inline-block">readymade gluten
                </h1>
                <p class="mb-8 leading-relaxed">Copper mug try-hard pitchfork pour-over freegan heirloom neutra air plant cold-pressed tacos poke beard tote bag. Heirloom echo park mlkshk tote bag selvage hot chicken authentic tumeric truffaut hexagon try-hard chambray.</p>
                <div class="flex justify-between gap-3">
                    <x-project-link :href="'https://pokedex-dorianlaguna.domcloud.io'">
                        Pagina
                    </x-project-link>
